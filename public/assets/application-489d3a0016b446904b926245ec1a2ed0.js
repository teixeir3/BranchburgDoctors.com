...
var collapseCheck = function() {
  if (scrollCheck(265)) {
    addClasses({'body': 'collapsed', 'header': 'navbar-fixed-top'});
    removeClasses({'header': 'navbar-static-top'});
  } else {
    removeClasses({'body': 'collapsed', 'header': 'navbar-fixed-top'});
    addClasses({'header': 'navbar-static-top'});
  }
};
...
$(document).on('page:change', function() {
  ...
  $(".fa").on("click", function(event) {
    $(event.target).toggleClass("fa-lg");
  });
